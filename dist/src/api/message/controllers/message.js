...
exports.default = strapi_1.factories.createCoreController('api::message.message', ({ strapi }) => ({
    async createByDocumentId(ctx) {
        ...
        if (!documentId || !(message === null || message === void 0 ? void 0 : message.trim())) {
        ...
        if (!item)
            return ctx.notFound('Item not found for documentId.');
        // Create the message and link the item
        const created = await strapi.entityService.create('api::message.message', {
            data: {
                message: message.trim(),
                sender_name: (sender_name === null || sender_name === void 0 ? void 0 : sender_name.trim()) || null,
                sender_email: (sender_email === null || sender_email === void 0 ? void 0 : sender_email.trim()) || null,
                sender_phone: (sender_phone === null || sender_phone === void 0 ? void 0 : sender_phone.trim()) || null,
                item: item.id,
            },
